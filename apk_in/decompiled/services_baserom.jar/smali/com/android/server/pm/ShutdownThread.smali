...
.method private static beginShutdownSequence(Landroid/content/Context;Z)V
    ...
    .local v3, im:Landroid/hardware/input/IInputManager;
    const/4 v5, 0x1

    :try_start_1
    invoke-interface {v3, v5}, Landroid/hardware/input/IInputManager;->setStartedShutdown(Z)V
    :try_end_1
    ...
    iput-object v11, v5, Lcom/android/server/pm/ShutdownThread;->mCpuWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v6, v6, Lcom/android/server/pm/ShutdownThread;->mPowerManager:Landroid/os/PowerManager;
    ...
    iput-object v6, v5, Lcom/android/server/pm/ShutdownThread;->mCpuWakeLock:Landroid/os/PowerManager$WakeLock;

    sget-object v5, Lcom/android/server/pm/ShutdownThread;->sInstance:Lcom/android/server/pm/ShutdownThread;

    iget-object v5, v5, Lcom/android/server/pm/ShutdownThread;->mCpuWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v11, v5, Lcom/android/server/pm/ShutdownThread;->mScreenWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v6, v5, Lcom/android/server/pm/ShutdownThread;->mScreenWakeLock:Landroid/os/PowerManager$WakeLock;

    sget-object v5, Lcom/android/server/pm/ShutdownThread;->sInstance:Lcom/android/server/pm/ShutdownThread;

    iget-object v5, v5, Lcom/android/server/pm/ShutdownThread;->mScreenWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    .end local v3           #im:Landroid/hardware/input/IInputManager;
    :catchall_0
    move-exception v5
    ...
    .restart local v3       #im:Landroid/hardware/input/IInputManager;
    :catch_0
    move-exception v1
    ...
    const-string v6, "error occur while input disable"

    invoke-static {v5, v6, v1}, Lcom/android/server/pm/ShutdownThread$Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)I
