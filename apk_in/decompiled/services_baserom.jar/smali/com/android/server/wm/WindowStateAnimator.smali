...
.method createSurfaceLocked()Landroid/view/Surface;
    ...
    iget v1, v1, Lcom/android/server/wm/WindowState;->mSurfaceZoomX:F

    iget-object v2, p0, Lcom/android/server/wm/WindowStateAnimator;->mWin:Lcom/android/server/wm/WindowState;

    iget v2, v2, Lcom/android/server/wm/WindowState;->mSurfaceZoomY:F

    invoke-virtual {v0, v1, v2}, Landroid/view/Surface;->setZoomPosition(FF)V

    iget-object v0, p0, Lcom/android/server/wm/WindowStateAnimator;->mSurface:Landroid/view/Surface;

    iget-object v1, p0, Lcom/android/server/wm/WindowStateAnimator;->mWin:Lcom/android/server/wm/WindowState;

    iget v1, v1, Lcom/android/server/wm/WindowState;->mSurfaceMagnificationFactor:F

    invoke-virtual {v0, v1}, Landroid/view/Surface;->setMagnificationFactor(F)V
...
.method public prepareSurfaceLocked(Z)V
    ...
    iget v3, v2, Lcom/android/server/wm/WindowState;->mSurfaceZoomX:F

    iget v4, v2, Lcom/android/server/wm/WindowState;->mLastSurfaceZoomX:F

    cmpl-float v3, v3, v4

    if-nez v3, :cond_7

    iget v3, v2, Lcom/android/server/wm/WindowState;->mSurfaceZoomY:F

    iget v4, v2, Lcom/android/server/wm/WindowState;->mLastSurfaceZoomY:F

    cmpl-float v3, v3, v4

    if-nez v3, :cond_7

    iget v3, v2, Lcom/android/server/wm/WindowState;->mSurfaceMagnificationFactor:F

    iget v4, v2, Lcom/android/server/wm/WindowState;->mLastSurfaceMagnificationFactor:F
    ...
    const-string v5, "w.mSurfaceMagnificationFactor="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, v2, Lcom/android/server/wm/WindowState;->mSurfaceMagnificationFactor:F

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, " w.mLastSurfaceMagnificationFactor="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, v2, Lcom/android/server/wm/WindowState;->mLastSurfaceMagnificationFactor:F
    ...
    iget v4, v2, Lcom/android/server/wm/WindowState;->mSurfaceMagnificationFactor:F

    invoke-virtual {v3, v4}, Landroid/view/Surface;->setMagnificationFactor(F)V

    iget v3, v2, Lcom/android/server/wm/WindowState;->mSurfaceMagnificationFactor:F

    iput v3, v2, Lcom/android/server/wm/WindowState;->mLastSurfaceMagnificationFactor:F
    ...
    const-string v5, "w.mSurfaceZoomX="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, v2, Lcom/android/server/wm/WindowState;->mSurfaceZoomX:F

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, " w.mLastSurfaceZoomX="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, v2, Lcom/android/server/wm/WindowState;->mLastSurfaceZoomX:F

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, "w.mSurfaceZoomY="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, v2, Lcom/android/server/wm/WindowState;->mSurfaceZoomY:F

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, " w.mLastSurfaceZoomY="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, v2, Lcom/android/server/wm/WindowState;->mLastSurfaceZoomY:F
    ...
    iget v4, v2, Lcom/android/server/wm/WindowState;->mSurfaceZoomX:F

    iget v5, v2, Lcom/android/server/wm/WindowState;->mSurfaceZoomY:F

    invoke-virtual {v3, v4, v5}, Landroid/view/Surface;->setZoomPosition(FF)V

    iget v3, v2, Lcom/android/server/wm/WindowState;->mSurfaceZoomX:F

    iput v3, v2, Lcom/android/server/wm/WindowState;->mLastSurfaceZoomX:F

    iget v3, v2, Lcom/android/server/wm/WindowState;->mSurfaceZoomY:F

    iput v3, v2, Lcom/android/server/wm/WindowState;->mLastSurfaceZoomY:F
