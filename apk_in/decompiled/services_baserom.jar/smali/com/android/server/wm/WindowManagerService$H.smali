...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wm/WindowState;->getWindowModeLw()I
    ...
    .local v22, notifyFocusIntent:Landroid/content/Intent;
    ...
    .end local v22           #notifyFocusIntent:Landroid/content/Intent;
    .end local v38           #zoneInfo:I
    :cond_3
    :goto_1
    move-object/from16 v0, p0
    ...
    .local v21, newHold:Lcom/android/server/wm/Session;
    ...
    .end local v21           #newHold:Lcom/android/server/wm/Session;
    ...
    .local v19, mws:Lcom/android/server/am/MultiWindowManagerService;
    if-eqz v19, :cond_0
    ...
    .end local v19           #mws:Lcom/android/server/am/MultiWindowManagerService;
    .end local v29           #taskId:I
    ...
    .restart local v19       #mws:Lcom/android/server/am/MultiWindowManagerService;
    .restart local v29       #taskId:I
    .restart local v36       #windowState:Lcom/android/server/wm/WindowState;
    :cond_19
    const/high16 v11, 0x1000

    .local v11, MOVE_TASK_FROM_OTHER_APP_TOUCH:I
    move-object/from16 v0, p0
    ...
    .end local v11           #MOVE_TASK_FROM_OTHER_APP_TOUCH:I
    .end local v19           #mws:Lcom/android/server/am/MultiWindowManagerService;
    .end local v29           #taskId:I
    .end local v36           #windowState:Lcom/android/server/wm/WindowState;
    :catch_8
