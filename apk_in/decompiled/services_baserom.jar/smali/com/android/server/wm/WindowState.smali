...
.field mLastSurfaceMagnificationFactor:F

.field mLastSurfaceZoomX:F

.field mLastSurfaceZoomY:F
...
.field mSurfaceMagnificationFactor:F

.field mSurfaceZoomX:F

.field mSurfaceZoomY:F
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/Session;Landroid/view/IWindow;Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;ILandroid/view/WindowManager$LayoutParams;I)V
    ...
    iget v5, p7, Landroid/view/WindowManager$LayoutParams;->zoomX:I

    int-to-float v5, v5

    iput v5, p0, Lcom/android/server/wm/WindowState;->mSurfaceZoomX:F

    iput v5, p0, Lcom/android/server/wm/WindowState;->mLastSurfaceZoomX:F

    iget v5, p7, Landroid/view/WindowManager$LayoutParams;->zoomY:I

    int-to-float v5, v5

    iput v5, p0, Lcom/android/server/wm/WindowState;->mSurfaceZoomY:F

    iput v5, p0, Lcom/android/server/wm/WindowState;->mSurfaceZoomY:F

    iget v5, p7, Landroid/view/WindowManager$LayoutParams;->magnificationFactor:F

    iput v5, p0, Lcom/android/server/wm/WindowState;->mSurfaceMagnificationFactor:F

    iput v5, p0, Lcom/android/server/wm/WindowState;->mLastSurfaceMagnificationFactor:F
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    :cond_1b
    iget v1, p0, Lcom/android/server/wm/WindowState;->mSurfaceMagnificationFactor:F
    ...
    const-string v1, "mSurfaceMagnificationFactor="
    ...
    :cond_1c
    iget v1, p0, Lcom/android/server/wm/WindowState;->mSurfaceZoomX:F

    cmpl-float v1, v1, v5

    if-nez v1, :cond_1d

    iget v1, p0, Lcom/android/server/wm/WindowState;->mSurfaceZoomY:F
