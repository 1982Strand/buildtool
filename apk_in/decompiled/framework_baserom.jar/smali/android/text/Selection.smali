...
.method public static setSelection(Landroid/text/Spannable;II)V
    ...
    .local v4, stopChar:C
    invoke-static {v3}, Landroid/text/TextUtils;->isIndianVowel(C)Z

    move-result v5

    if-nez v5, :cond_0

    invoke-static {v3}, Landroid/text/TextUtils;->isThaiVowel(C)Z

    move-result v5

    if-nez v5, :cond_0

    invoke-static {v4}, Landroid/text/TextUtils;->isIndianVowel(C)Z

    move-result v5

    if-nez v5, :cond_0

    invoke-static {v4}, Landroid/text/TextUtils;->isThaiVowel(C)Z
    ...
    invoke-interface {p0, v5, p1, p1, v6}, Landroid/text/Spannable;->setSpan(Ljava/lang/Object;III)V

    sget-object v5, Landroid/text/Selection;->SELECTION_END:Ljava/lang/Object;

    const/16 v6, 0x22

    invoke-interface {p0, v5, p2, p2, v6}, Landroid/text/Spannable;->setSpan(Ljava/lang/Object;III)V

    :cond_3
    return-void

    .restart local v3       #startChar:C
    .restart local v4       #stopChar:C
    :cond_4
