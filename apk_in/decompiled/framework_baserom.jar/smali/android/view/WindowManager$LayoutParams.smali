...
.field public static final MAGNIFICATION_FACTOR_CHANGED:I = 0x20000
...
.field public static final TYPE_MAGNIFIER:I = 0x8fc

.field public static final TYPE_MAGNIFIER_PANEL:I = 0x8fd
...
.field public static final ZOOM_POSITION_CHANGED:I = 0x40000
...
.field public magnificationFactor:F
...
.field public zoomX:I

.field public zoomY:I
...
.method public constructor <init>()V
    ...
    iput v0, p0, Landroid/view/WindowManager$LayoutParams;->magnificationFactor:F

    iput v4, p0, Landroid/view/WindowManager$LayoutParams;->zoomX:I

    iput v4, p0, Landroid/view/WindowManager$LayoutParams;->zoomY:I
...
.method public constructor <init>(IIIII)V
    ...
    iput v3, p0, Landroid/view/WindowManager$LayoutParams;->zoomX:I

    iput v3, p0, Landroid/view/WindowManager$LayoutParams;->zoomY:I
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput v1, p0, Landroid/view/WindowManager$LayoutParams;->zoomX:I

    iput v1, p0, Landroid/view/WindowManager$LayoutParams;->zoomY:I
    ...
    iput v0, p0, Landroid/view/WindowManager$LayoutParams;->zoomX:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v0

    iput v0, p0, Landroid/view/WindowManager$LayoutParams;->zoomY:I
...
.method public final copyFrom(Landroid/view/WindowManager$LayoutParams;)I
    ...
    :cond_13
    iget v1, p0, Landroid/view/WindowManager$LayoutParams;->magnificationFactor:F

    iget v2, p1, Landroid/view/WindowManager$LayoutParams;->magnificationFactor:F

    cmpl-float v1, v1, v2

    if-eqz v1, :cond_14

    iget v1, p1, Landroid/view/WindowManager$LayoutParams;->magnificationFactor:F

    iput v1, p0, Landroid/view/WindowManager$LayoutParams;->magnificationFactor:F
    ...
    :cond_14
    iget v1, p0, Landroid/view/WindowManager$LayoutParams;->zoomX:I

    iget v2, p1, Landroid/view/WindowManager$LayoutParams;->zoomX:I

    if-eq v1, v2, :cond_15

    iget v1, p1, Landroid/view/WindowManager$LayoutParams;->zoomX:I
    ...
    :cond_15
    iget v1, p0, Landroid/view/WindowManager$LayoutParams;->zoomY:I

    iget v2, p1, Landroid/view/WindowManager$LayoutParams;->zoomY:I

    if-eq v1, v2, :cond_16

    iget v1, p1, Landroid/view/WindowManager$LayoutParams;->zoomY:I
...
.method public toString()Ljava/lang/String;
    ...
    const-string v2, "WM.LayoutParams{"
    ...
    const-string v2, " compatible=true"
    ...
    .local v0, dumpMagnifierAlways:Z
    if-nez v0, :cond_10

    iget v2, p0, Landroid/view/WindowManager$LayoutParams;->magnificationFactor:F
    ...
    iget v3, p0, Landroid/view/WindowManager$LayoutParams;->magnificationFactor:F
    ...
    iget v2, p0, Landroid/view/WindowManager$LayoutParams;->zoomX:I

    if-eqz v2, :cond_13

    :cond_12
    const-string v2, " zoomX="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Landroid/view/WindowManager$LayoutParams;->zoomX:I
    ...
    iget v2, p0, Landroid/view/WindowManager$LayoutParams;->zoomY:I

    if-eqz v2, :cond_15

    :cond_14
    const-string v2, " zoomY="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Landroid/view/WindowManager$LayoutParams;->zoomY:I
    ...
    .end local v0           #dumpMagnifierAlways:Z
    :cond_16
    iget v2, p0, Landroid/view/ViewGroup$LayoutParams;->width:I
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget v0, p0, Landroid/view/WindowManager$LayoutParams;->magnificationFactor:F

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeFloat(F)V

    iget v0, p0, Landroid/view/WindowManager$LayoutParams;->zoomX:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    iget v0, p0, Landroid/view/WindowManager$LayoutParams;->zoomY:I
