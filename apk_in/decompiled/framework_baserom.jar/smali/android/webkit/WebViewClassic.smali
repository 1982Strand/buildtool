...
.method private handleTouchEventCommon(Landroid/view/MotionEvent;III)V
    ...
    .restart local v35       #prevSnapScrollMode:I
    :cond_1f
    move-object/from16 v0, p0
    ...
    .restart local v29       #inCursorText:Z
    .restart local v30       #inEditBounds:Z
...
.method private setApnProxy(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string v11, "setApnProxy: cmwap"
...
.method private startDrag()V
    ...
    const-string v2, "startDrag mCurrentScrollingLayerId = "
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v6}, Landroid/webkit/WebView;->isClickable()Z
    ...
    invoke-virtual {v6}, Landroid/webkit/WebView;->isLongClickable()Z
    ...
    iget-object v6, p0, Landroid/webkit/WebViewClassic;->mMagnifier:Landroid/webkit/WebMagnifier;

    invoke-virtual {v6}, Landroid/webkit/WebMagnifier;->hide()V

    :cond_2
    iget-object v6, p0, Landroid/webkit/WebViewClassic;->mInputDispatcher:Landroid/webkit/WebViewInputDispatcher;

    if-eqz v6, :cond_0

    iget-object v6, p0, Landroid/webkit/WebViewClassic;->mWebView:Landroid/webkit/WebView;

    invoke-virtual {v6}, Landroid/webkit/WebView;->isFocusable()Z
    ...
    invoke-virtual {v6}, Landroid/webkit/WebView;->isFocusableInTouchMode()Z
    ...
    invoke-virtual {v6}, Landroid/webkit/WebView;->isFocused()Z
    ...
    :cond_3
    sget-boolean v6, Landroid/webkit/DebugFlags;->WEB_TOUCH_LOG:Z
    ...
    iget v6, p0, Landroid/webkit/WebViewClassic;->mTouchSlopSquareForSPen:I

    iput v6, p0, Landroid/webkit/WebViewClassic;->mTouchSlopSquare:I
    ...
    iput v6, p0, Landroid/webkit/WebViewClassic;->actionDown_X:I
    ...
    iput v6, p0, Landroid/webkit/WebViewClassic;->actionDown_Y:I

    iget-object v6, p0, Landroid/webkit/WebViewClassic;->mInputDispatcher:Landroid/webkit/WebViewInputDispatcher;

    invoke-virtual {v6, v8}, Landroid/webkit/WebViewInputDispatcher;->setTouchDragMode(Z)V
    ...
    invoke-virtual {v6, v8}, Landroid/webkit/ZoomManager;->SetIsActionPU(Z)V
    ...
    invoke-virtual {v6}, Landroid/webkit/ZoomManager;->getTiltListener()Landroid/webkit/TiltListener;

    move-result-object v2

    .local v2, currentTiltListener:Landroid/webkit/TiltListener;
    if-ne v0, v13, :cond_7

    iget-object v6, p0, Landroid/webkit/WebViewClassic;->mZoomManager:Landroid/webkit/ZoomManager;

    invoke-virtual {v6, v7}, Landroid/webkit/ZoomManager;->SetIsActionPU(Z)V
    ...
    invoke-virtual {v6}, Landroid/webkit/ZoomManager;->unregisterTiltListener()V

    if-eqz v2, :cond_9

    invoke-virtual {v2, v8}, Landroid/webkit/TiltListener;->setTiltUse(Z)V
    ...
    .local v4, tiltStart:J
    if-eqz v2, :cond_a

    invoke-virtual {v2, v4, v5}, Landroid/webkit/TiltListener;->setTiltStartTime(J)V

    :cond_a
    iget-object v6, p0, Landroid/webkit/WebViewClassic;->mZoomManager:Landroid/webkit/ZoomManager;

    invoke-virtual {v6}, Landroid/webkit/ZoomManager;->registerTiltListener()V

    .end local v2           #currentTiltListener:Landroid/webkit/TiltListener;
    .end local v4           #tiltStart:J
    :cond_b
    iget-object v6, p0, Landroid/webkit/WebViewClassic;->mZoomManager:Landroid/webkit/ZoomManager;
    ...
    invoke-virtual {v6, v7}, Landroid/webkit/ZoomManager;->setHandleMoveEvForZooming(Z)V
    ...
    :goto_2
    iput-boolean v6, p0, Landroid/webkit/WebViewClassic;->mMaybeScrollDown:Z
    ...
    iput v6, p0, Landroid/webkit/WebViewClassic;->mAx:I
    ...
    iput v6, p0, Landroid/webkit/WebViewClassic;->mAy:I
    ...
    invoke-virtual {v6, p1, v9, v10, v11}, Landroid/webkit/WebViewInputDispatcher;->postPointerEvent(Landroid/view/MotionEvent;IIF)Z
    ...
    invoke-virtual {v6}, Landroid/webkit/WebViewInputDispatcher;->dispatchUiEvents()V
    ...
    :cond_e
    iget v6, p0, Landroid/webkit/WebViewClassic;->mTouchSlopSquareForFinger:I
    ...
    const-string v7, "mInputDispatcher rejected the event!"
