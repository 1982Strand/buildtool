...
.method constructor <init>(Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;ZZ)V
    ...
    iput-boolean p2, p0, Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen$6;->val$success:Z

    iput-boolean p3, p0, Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen$6;->val$showLock:Z
...
.method public run()V
    ...
    iget-boolean v1, p0, Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen$6;->val$success:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen$6;->this$0:Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;
    ...
    invoke-static {v1}, Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;->access$1000(Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;)Lcom/android/internal/widget/LockPatternUtils;
    ...
    invoke-static {v1}, Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;->access$1100(Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;)Z
    ...
    invoke-static {v1}, Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;->access$400(Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;)Ljava/util/ArrayList;
    ...
    invoke-static {v1}, Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;->access$100(Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;)Lcom/android/internal/policy/impl/KeyguardScreenCallback;
    ...
    :cond_1
    iget-boolean v1, p0, Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen$6;->val$showLock:Z
    ...
    #getter for: Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;->mContext:Landroid/content/Context;
    invoke-static {v1}, Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;->access$1300(Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;)Landroid/content/Context;
    ...
    iget-object v2, p0, Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen$6;->this$0:Lcom/android/internal/policy/impl/MiuiAccountUnlockScreen;
